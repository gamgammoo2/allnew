...
plt.title(str(len(df)) + '개 매장 집계 ')

filename = 'visualizationExam_1.png'
plt.savefig(filename)
print(filename + ' saved ..... ')

print('집계 매소드를 사전에 담아 전달')
...
filename = 'visualizationExam_2.png'
plt.savefig(filename)
print(filename, 'saved ....')
...
filename = 'visualizationExam_3.png'
plt.savefig(filename)
print(filename, 'saved ....')
print('finished')